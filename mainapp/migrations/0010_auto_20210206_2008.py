# Generated by Django 3.1.5 on 2021-02-06 17:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0009_auto_20210204_2006'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обраотке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='new', max_length=100, verbose_name='Статус заказа')),
